...
NebulaAI uses [Weblate](https://hosted.weblate.org/translate/pocketpal-ai) for managing translations. When adding or changing user-facing strings:
...
**To contribute translations**, visit [NebulaAI on Weblate](https://hosted.weblate.org/translate/pocketpal-ai) — no code changes needed.
